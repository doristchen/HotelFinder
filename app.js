...
var bot = new builder.UniversalBot(connector, [
    ...
    function (session) {
        session.replaceDialog("HotelDialog")
        return session.beginDialog('hotels');
    }
]);
...
bot.dialog('HotelDialog', function (session) {
    var msg = new builder.Message(session)
        .speak(speak(session, 'hotel_ssml'))
        .text("I'm a hotel finder");
    session.send(msg).endDialog();
}).triggerAction({ matches: /hotel/i });
